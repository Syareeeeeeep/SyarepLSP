...
<body>
        ...
        <div class="bg-[#F7F5FF] flex justify-between h-[520px] sm:h-[80vh] md:h-[50vh] lg:h-[80vh] w-[350px] sm:w-[600px] md:w-[700px] lg:w-[900px] rounded-xl overflow-hidden shadow-lg px-4 sm:px-0 mt-4 sm:mt-0">
            <div class="kiri w-full lg:w-1/2 p-2 sm:p-6">
                <div class="atas flex items-center justify-between w-full mt-2 sm:mt-0">
                    ...
                    <ul class="flex gap-4">
                        <li><a href="form_login.php" class="font-medium opacity-50 hover:opacity-100 hidden sm:inline">Login</a></li>
                ...
                <div class="bawah p-2 sm:p-5 flex flex-col justify-center mt-10">
                    <div>
                        ...
                        <p class="text-sm font-semibold mt-3"><span class="opacity-50">Already Have an Account?</span> <a href="form_login.php" class="text-[#8271FF]">Login</a></p>
                    </div>
    ...
    <?php if($signup_message === "berhasil") : ?>
       <script>
            Swal.fire({
                icon: 'success',
                title: 'Berhasil!',
    ...
    <?php elseif ($signup_message === "gagal") : ?>
        <script>
            Swal.fire({
                icon: 'error',
                title: 'Gagal!',
